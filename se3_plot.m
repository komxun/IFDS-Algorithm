...
%% ================ Figure 2 : Translational States ===================
figure(2); clf
sgtitle('Translational States (solid = actual, dashed = desired)')
